<?php
// admin/controller/laporansewa_controller.php
if (session_status() === PHP_SESSION_NONE) {
  session_start();
}
require_once __DIR__ . '/../../konfig/koneksi.php';
require_once __DIR__ . '/../model/laporansewa_model.php';
...
$filter = [
  ...
  'mtode_byr'   => $_GET['mtode_byr'] ?? '',
  'jns_byr'     => $_GET['jns_byr'] ?? ''
];
...
$data_untuk_view = [
  'judul_halaman'      => ($aksi === 'cetak') ? 'Cetak Laporan Pendapatan Sewa' : 'Laporan Pendapatan Sewa',
...
require_once __DIR__ . '/../view/laporansewa_view.php';
